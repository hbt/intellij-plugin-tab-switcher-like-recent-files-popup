...
public class MySwitcher extends AnAction implements DumbAware {
  ...
  public static class SwitcherPanel extends JPanel implements KeyListener, MouseListener, MouseMotionListener, DataProvider {
    ...
    SwitcherPanel(@NotNull final Project project, @NotNull String title, boolean pinned) {
      ...
      // TODO(hbt) NEXT fix
//      toolWindows.setCellRenderer(new com.intellij.ide.actions.SwitcherToolWindowsListRenderer(mySpeedSearch, map, myPinned) {
//        @NotNull
//        @Override
